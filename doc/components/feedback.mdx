...
![Hux badge component showing rounded blue label with Hux logo and 'Beta' tag](/images/hux-badge.png)

![Hux alert component showing red error banner with exclamation icon and sample message](/images/hux-alerts.png)
